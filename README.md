# Sapper + tailwindCSS 脚手架

配置参考自 [Getting Tailwind CSS to integrate nicely with Svelte + Sapper](https://www.apostrof.co/blog/getting-tailwind-css-to-integrate-nicely-with-svelte-sapper/)
